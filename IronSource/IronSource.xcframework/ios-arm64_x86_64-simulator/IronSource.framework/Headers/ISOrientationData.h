...
@property(nonatomic) UIInterfaceOrientationMask
    topMostViewControllerOrientation;  // presented view controller orientation
@property(nonatomic)
    BOOL topMostViewControllerShouldAutorotate;  // presented view controller shouldAutorotate value
@property(nonatomic) UIInterfaceOrientation
    preferredInterfaceOrientationForPresentation;  // preferred interface orientation
